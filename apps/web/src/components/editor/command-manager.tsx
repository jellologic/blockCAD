...
import {
  ...
  Eye, Layers, Network, Maximize2, BoxSelect, Pencil,
} from "lucide-react";
import { RibbonButton } from "./ribbon-button";
import { useEditorStore } from "@/stores/editor-store";
import { PlaneSelector } from "@/components/sketch/plane-selector";
...
export function CommandManager() {
  ...
  // Auto-switch to sketch tab when entering sketch mode
  useEffect(() => {
    if (mode === "sketch") {
      setActiveTab("sketch");
    }
            ...
            <>
              <RibbonGroup label="Sketch">
                <RibbonButton
                  ...
                  onClick={() => setPlaneSelectorOpen(true)}
                />
              </RibbonGroup>
